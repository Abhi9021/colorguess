...
public class MainActivity7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edtfrobj=findViewById(R.id.edtsix);
        next4obj=findViewById(R.id.btnnext6);
        check4obj=findViewById(R.id.btncheck6);
        img4obj=findViewById(R.id.img6);


        check4obj.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if(edtfrobj.getText().toString().trim().equals("Gray")||edtfrobj.getText().toString().trim().equals("gray"))
                {
                    ...
                    btn.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            dialog.dismiss();
                            Intent q=new Intent(MainActivity7.this,MainActivity7.class);
                            startActivity(q);
                        }
                    });
        ...
        next4obj.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent p=new Intent(MainActivity7.this,MainActivity7.class);
                startActivity(p);
            }
        });
    }
